...
#ELEVATOR 1
#Arrow images
down_arrow=Image.open("assets/down_arrow.png")
down_arrow=down_arrow.resize((35,35))
down_arrow=ImageTk.PhotoImage(down_arrow)
up_arrow=Image.open("assets/up_arrow.png")
up_arrow=up_arrow.resize((35,35))
up_arrow=ImageTk.PhotoImage(up_arrow)
#Fan Images
...
btn4=Button(frame3,bg='#7e7e7e',image=down_arrow,command=request_4_down)
btn4.place(x=25,y=50,height=50,width=50)
btn3_1=Button(frame3,bg="#7e7e7e",image=up_arrow,command=request_3_up)
btn3_1.place(x=25,y=145,height=50,width=50)
btn3_2=Button(frame3,bg='#7e7e7e',image=down_arrow,command=request_3_down)
btn3_2.place(x=25,y=205,height=50,width=50)
btn2_1=Button(frame3,bg="#7e7e7e",image=up_arrow,command=request_2_up)
btn2_1.place(x=25,y=265,height=50,width=50)
btn2_2=Button(frame3,bg='#7e7e7e',image=down_arrow,command=request_2_down)
btn2_2.place(x=25,y=325,height=50,width=50)
btn1_1=Button(frame3,bg="#7e7e7e",image=up_arrow,command=request_1_up)
btn1_1.place(x=25,y=385,height=50,width=50)
btn1_2=Button(frame3,bg='#7e7e7e',image=down_arrow,command=request_1_down)
btn1_2.place(x=25,y=445,height=50,width=50)
btn0=Button(frame3,bg='#7e7e7e',image=up_arrow,command=request_0_up)
